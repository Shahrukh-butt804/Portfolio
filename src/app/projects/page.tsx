...
function Page() {
  ...
  },
  {
    ...
    image: "/images/weather-app-ss.png",
  ...
  },
  {
    ...
    image: "/images/Github_search_SS.png",
  ...
  },
  {
    ...
    image: "/images/calculaotor_SS.png",
      ...
      ">
        ...
        mb-10 ">
          ...
          <div className=" bg-white rounded-lg   justify-center items-center">
            <Image src={projects[projectIndex].image} alt="project image" width={800} height={100}  className="w-full  h-full rounded-lg" />
          </div>
